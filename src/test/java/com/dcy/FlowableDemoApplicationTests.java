...
public class FlowableDemoApplicationTests {
    ...
    public void complete() {
        String taskId = "f25a7b7a-1b24-11ea-abef-04d4c48d288f";
    ...
    public void getUserTaskList() {
        String flowId ="student_leave:2:3b0faf74-1af3-11ea-8a14-0242ac160002";
    ...
    public void addGroup() {
        Group group = identityService.newGroup("108-school");
        group.setName("108中学");
    ...
    public void testSaveMembership() {
        identityService.createMembership("pri", "108-school");
    }

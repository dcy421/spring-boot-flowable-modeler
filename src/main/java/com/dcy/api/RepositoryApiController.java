...
//
//    @Resource
//    protected ModelHistoryResource modelHistoryResource;
//
//    @Resource
//    protected ModelBpmnResource modelBpmnResource;
//
//    @Resource
...
//    public String changeModelHistoryVersion(@PathVariable(value="modelId") String modelId, @PathVariable(value="modelHistoryId") String modelHistoryId,
...
//        } catch (Exception e) {
//            return JsonUtil.toJSON(ErrorMsg.ERROR.setNewErrorMsg("版本回滚失败，请重试"));
//        }
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewErrorMsg("版本回滚成功"));*/
//        return null;
//    }
//
//    /**
...
//    public String flowDeployment(@PathVariable(value = "modelId") String modelId, @PathVariable(value = "tenantId") String tenantId) {
//        /*try {
//            // 根据模型 ID 获取模型
...
//                return JsonUtil.toJSON(ErrorMsg.SELECT_ERROR.setNewErrorMsg("模型数据为空，请先设计流程并成功保存，再进行发布"));
//            }
//
//            BpmnModel model = modelService.getBpmnModel(modelData);
//            if (model.getProcesses().size() == 0) {
//                logger.error("数据模型不符要求，请至少设计一条主线流程");
//                return JsonUtil.toJSON(ErrorMsg.SELECT_ERROR.setNewErrorMsg("数据模型不符要求，请至少设计一条主线流程"));
//            }
...
//            return JsonUtil.toJSON(ErrorMsg.SAVE_ERROR.setNewErrorMsg("发布失败，流程图不正确"));
//        }
//        logger.info("流程部署成功：" + modelId + " " + new Date());
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewErrorMsg("发布成功"));*/
//        return null;
//    }
//
//    /**
...
//    public String processDefinedHangChange(@PathVariable(value = "processDefinedId") String processDefinedId) {
...
//    public String deleteProcessDefined(@PathVariable(value = "deploymentId") String deploymentId, @RequestParam(value = "isForce", defaultValue = "false") boolean isForce) {
//        if (isForce) {
//            // 级联删除，实例，历史都会被删除
...
//                return JsonUtil.toJSON(ErrorMsg.DELETE_ERROR.setNewErrorMsg("有正在运行的流程，不能删除"));
//            }
//        }
////        return JsonUtil.toJSON(ErrorMsg.DELETE_SUCCESS);
//        return null;
//    }
//
//    /**
...
//    public String flowModels(@PathVariable(value = "sort") String sort, HttpServletRequest request) {
...
//            }
//        }));
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewData(modelsVo));*/
//        return null;
//    }
//
//    /**
...
//    public String flowModels(HttpServletRequest request) {
...
//    public String getModelHistory(@PathVariable(value="modelId") String modelId) {
...
//            }
//        }
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewData(modelHistoryList));
//    }
//
//    /**
//     * 流程模型数据
...
//    public String getFlowModel(@PathVariable(value = "processDefinedId") String processDefinedId) {
//        BpmnModel bpmnModel = repositoryService.getBpmnModel(processDefinedId);
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewData(bpmnModel.getProcesses()));
//    }
//
//    /**
//     * 获取租户流程定义列表
...
//    public String getProcessDefinedListByTenant(@RequestBody List<String> tenantList) {
//        // 返回数据集
...
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewData(processDefinitionVoList));
//    }
//
//    /**
//     * 获取租户流程定义列表，带分页
...
//    public String getTenantProcessDefinedList(@RequestBody FlowableQueryEntity flowableQueryEntity) {
//        // 页码
...
//    public String getProcessDefinedTaskList(@PathVariable(value = "processDefinedKey") String processDefinedKey, @PathVariable(value = "tenant") String tenant) {

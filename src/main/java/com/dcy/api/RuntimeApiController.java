...
//    public String flowStart(@PathVariable(value = "processDefinedId") String processDefinedId, @PathVariable(value = "startUser") String startUser, @PathVariable(value = "dataKey") String dataKey) {
//        // 判断挂起状态，true 挂起， false 未挂起
//        if (repositoryService.isProcessDefinitionSuspended(processDefinedId)) {
//            return JsonUtil.toJSON(ErrorMsg.ERROR.setNewErrorMsg("流程处于挂起状态，无法启动"));
//        }
//        // 设置发起人
...
//        // 根据流程 ID 启动流程
//        ProcessInstance processInstance = managementService.executeCommand(new StartProcessInstanceWithNameCmd<ProcessInstance>(processDefinedId, pd.getName(), dataKey, map));
////        ProcessInstance processInstance = runtimeService.startProcessInstanceById(processDefinedId, dataKey, map);
//        logger.info("流程定义启动成功：" + processDefinedId + " " + new Date());
//        logger.info("流程ID：" + processInstance.getId() + " " + new Date());
//        return JsonUtil.toJSON(ErrorMsg.SUCCESS.setNewData(processInstance.getId()));
//    }
//
//    /**
//     * 流程收回/驳回
...
//    public String processInstanceHangChange(@PathVariable(value = "processInstanceId") String processInstanceId) {
//        // 判断挂起状态，true 挂起， false 未挂起
...
//    public String addExecution(@RequestParam(value = "parentExecutionId") String parentExecutionId, @RequestParam(value = "processInstanceId") String processInstanceId, @RequestBody List<String> assigneeList) {
...
//        return JsonUtil.toJSON(ErrorMsg.INSERT_SUCCESS);
//    }
//
//    /**
//     * 减签
...
//    public String deleteExecution(@PathVariable("executionId") String executionId, @PathVariable("completed") Boolean completed) {
...
//    public String setListProcessVariable(@PathVariable(value = "processInstanceId") String processInstanceId, @PathVariable(value = "key") String key, @PathVariable(value = "value") List value) {
//        if (runtimeService.createProcessInstanceQuery().processInstanceId(processInstanceId).singleResult().isSuspended()) {
//            return JsonUtil.toJSON(ErrorMsg.ERROR.setNewErrorMsg("任务处于挂起状态"));
//        }
...
//    public String deleteProcessInstance(@PathVariable(value = "processInstanceId") String processInstanceId) {
//        runtimeService.deleteProcessInstance(processInstanceId, "中止流程");
//        return JsonUtil.toJSON(ErrorMsg.DELETE_SUCCESS.setNewErrorMsg("流程已中止"));
//    }
//
//    /**
//     * 流程实例列表查询
...
//    public String getFlowinfo(@RequestBody FlowableQueryEntity flowableQueryEntity) {
//        // 页码
...
//    public String executionIsSuspended(@PathVariable(value = "executionId") String executionId) {
...
//    public String processIsSuspended(@PathVariable(value = "processInstanceId") String processInstanceId) {
